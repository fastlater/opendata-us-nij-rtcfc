...
CREATE SCHEMA IF NOT EXISTS NIJ_CFS_PORTLAND;

SET SEARCH_PATH TO NIJ_CFS_PORTLAND;
...
COPY NIJ_CFS_PORTLAND.NIJ_CFS_PORTLAND FROM LOCAL'NIJ_CFS_PORTLAND.sql.csv'
DELIMITER ','
ENCLOSED BY'"' ;