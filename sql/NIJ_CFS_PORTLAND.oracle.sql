...
"call_group" VARCHAR2(18),
"final_case_type" VARCHAR2(6),
"case_desc" VARCHAR2(45),
"occ_date" VARCHAR2(10),
"x_coordinate" NUMBER(7),
"y_coordinate" NUMBER(6),
"census_tract" VARCHAR2(6)
...
LOAD DATA INFILE 'NIJ_CFS_PORTLAND.sql.csv'
INTO TABLE "NIJ_CFS_PORTLAND"
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY'"' TRAILING NULLCOLS(NIJ_CFS_PORTLAND.category, NIJ_CFS_PORTLAND.call_group, NIJ_CFS_PORTLAND.final_case_type, NIJ_CFS_PORTLAND.case_desc, NIJ_CFS_PORTLAND.occ_date, NIJ_CFS_PORTLAND.x_coordinate, NIJ_CFS_PORTLAND.y_coordinate, NIJ_CFS_PORTLAND.census_tract);